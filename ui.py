...
class TeachChineseApp:
    ...
    def run(self):
        self.root = tk.Tk()
        self.root.title("TeachChinese")

        self.label = tk.Label(self.root, text="Welcome to TeachChinese!")
        self.label.pack()
        ...
        self.vocab_button = tk.Button(self.root, text="Show Vocabulary", command=self.show_vocabulary)
    ...
    def show_vocabulary(self):
        messagebox.showinfo("Vocabulary", str(self.vocab))
